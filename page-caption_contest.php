	...
	<section id="content" role="main" class="clearfix animated">
    	...
    	<div class="wrapper">
            ...
            <?php
            	...
            	$args = array(
            		'posts_per_page' => 1,
            		'category_name' => 'weekly-contests',
            		'paged' => $paged
        		);
        		$au_caption_contest_posts = new WP_Query($args);

        		if ($au_caption_contest_posts -> have_posts()) : ?>

        			<?php while($au_caption_contest_posts -> have_posts()) : $au_caption_contest_posts -> the_post(); ?>
        			...
        			<div class="au_pagination_links">
        				...
        				<span class="au_pagination_older_link">
        					<?php echo get_next_posts_link('Older Posts', $au_caption_contest_posts -> max_num_pages); ?>
        				</span>
